...
\begin{steproute}{Before Halicarnassus}
    \insertStep{../Graphics/Steps/201. Castle 1.jpg}
\end{steproute}
...
\begin{steproute}{Before Twintania}
    \insertStep{../Graphics/Steps/202. Castle 2.jpg}
\end{steproute}
...
\switchcolumn
\begin{steproute}{After Twintania}
    \insertStep{../Graphics/Steps/203. Castle 3.jpg}
\end{steproute}
